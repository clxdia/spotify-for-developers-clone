  ...
  return (
    <div className="w-[80%] xs, sm:w-[90%] m-auto text-center mb-[20rem]">
      ...
      <div className="flex sm:flex-col gap-[3vw]">
        <div className="flex flex-col justify-between xs, sm:w-full sm:h-auto bg-[url('/tile1.jpg')] bg-cover text-blue text-[18px] font-light p-10 bg-center w-[25vw] h-[53vw] ">
        ...
        <div className="sm:overflow-hidden ">
          <div className="flex gap-[3vw] xs:flex-col">
            <div className="flex flex-col sm:flex-auto sm:h-auto sm:w-[100%] justify-between bg-light_green hover:bg-[url('/tile2.svg')] transition ease-in-out delay-150 relative text-white text-left p-10 bg-[length:140%] bg-[center_left_1px] h-[25vw] w-[25vw] max-w-[450px] max-h-[450px] sm:max-w-none">
            ...
            <div className="flex flex-col sm:flex-auto sm:h-auto sm:w-[100%] justify-between hover:bg-[url('/tile3.svg')] relative bg-grey text-white p-10 text-left bg-[length:140%] bg-[center_left_1px] h-[25vw] w-[25vw] max-w-[450px] max-h-[450px] sm:max-w-none">
              <p className="text-[18px] font-[400]">BLOG</p>
              <p className="xs:text-[27px] text-[31px] font-extrabold">
          ...
          <div className="flex flex-col sm:h-auto justify-between bg-blue hover:bg-[url('/tile4.svg')] hover:animate-ltr-linear-infinite relative text-white p-10 text-left bg-[length:140%] bg-[center_left_1px] max-w-[1000px] h-[25vw] max-h-[450px] mt-[3vw]">
